...
export interface RubixError {
  code: Errors.GeneralErrorCodes;
  message: string;
}

export enum RubixDeployStatusEnum {
  SUCCESS = 'SUCCESS',
  FAILED = 'FAILED',
}

export interface RubixDeployResponse {
  status: RubixDeployStatusEnum;
  error?: string;
}

export enum RubixSystemStatus {
  INDEXING = 'INDEXING',
  FINISHED = 'FINISHED',
  FAILED = 'FAILED',
}

export enum RubixLanguage {
  EN = 'English',
  ES = 'Spanish',
  FR = 'French',
